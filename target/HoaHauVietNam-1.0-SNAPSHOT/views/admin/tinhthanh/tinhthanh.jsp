                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <a href="themtinhthanh" class="btn btn-secondary"><i
                                            class="material-icons">&#xE147;</i>
                                        <span>Thêm mới tỉnh thành</span></a>
                                </div>
                            </div>
                        </div>
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach items="${danhSachTinhThanh}" var="danhSachTinhThanh">
                                <tr>
                                    <td>${danhSachTinhThanh.idTinh}</td>
                                    <td>${danhSachTinhThanh.tenTinh}</td>
                                    <td>
                                        <a href="suatinhthanh?id=${danhSachTinhThanh.idTinh}" class="settings"
                                           title="Sửa" data-toggle="tooltip"><i
                                                class="material-icons">&#xE8B8;</i></a>
                                        <a href="#" class="delete" title="Xóa"
                                           onclick="xoa(${danhSachTinhThanh.idTinh},'${danhSachTinhThanh.tenTinh}')"
                        ...
                        <div class="row">
                            <ul class="pagination">
                                <c:forEach begin="1" end="${soTrang}" var="soThuTuTrang">
                                    <li class="page-item">
                                        <a href="showTinhThanh?idTrang=${soThuTuTrang}" class="page-link">${soThuTuTrang}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
...
<script>
    function xoa(id, name) {
        ...
        if (confirm(messenger)) {
            window.location = "xoatinhthanh?id=" + id;
        }
    }
</script>
</body>
