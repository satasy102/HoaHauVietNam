          ...
          <div class="table-responsive">
            <div class="table-wrapper">
              ...
              <table class="table table-striped table-hover">
                ...
                <tbody>
                <form action="suatinhthanh" method="post" id="formDemo">
                  <tr>
                    <td><input type="text" name="tenTinh" value="${tinhThanh.tenTinh}" class="form-control">
                      <input type="hidden" name="id" value="${tinhThanh.idTinh}"></td>
                    <td><button type="submit" class="btn btn-primary">Xong</button></td>
                  </tr>
                </form>
                </tbody>
              </table>
