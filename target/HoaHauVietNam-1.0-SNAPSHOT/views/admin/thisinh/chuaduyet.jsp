                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="admin?action=chuaduyet" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Danh sách thí sinh chưa duyệt</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-5">
                                    <h2>Danh sách <b>chưa duyệt</b></h2>
                                </div>
                                <div class="col-sm-7">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="status text-warning ">&bull;</span><a
                                            href="xetduyet?id=${danhSachThiSinh.idThiSinh}">Chờ
                                        duyệt</a>
                                    </td>
                                    <td>
