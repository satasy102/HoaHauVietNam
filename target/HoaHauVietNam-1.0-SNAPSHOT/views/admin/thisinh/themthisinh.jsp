        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Thêm mới hồ sơ thí sinh</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-xl">
        <div class="table-responsive">
          ...
          <form method="post" action="themthisinh" id="formDemo">
            <fieldset>
              <legend>Thông tin thí sinh</legend>
              <table class="table table-striped table-hover">
                <tr>
                  <td>Họ tên:</td>
                  <td><input type="text" name="ten" class="form-control" value="${thiSinh.hoTen}" required></td>
                </tr>
                <tr>
                  <td>Ngày sinh:</td>
                  <td><input type="date" name="ngaySinh" class="form-control" value="${thiSinh.ngaySinh}" required>
                  </td>
                </tr>
                <tr>
                  <td>Địa chỉ cụ thể:</td>
                  <td><input type="text" name="diaChiCuTru" class="form-control" value="${thiSinh.diaChiCuTru}"
                             required></td>
                </tr>
                <tr>
                  <td>Số điện thoại :</td>
                  <td><input type="text" name="sdt" class="form-control" value="${thiSinh.sdt}" required></td>
                </tr>
                <tr>
                  <td>Email:</td>
                  <td><input type="email" name="email" class="form-control" value="${thiSinh.email}" required></td>
                </tr>
                <tr>
                  <td>Chứng minh thư:</td>
                  <td><input type="text" name="cmt" class="form-control" value="${thiSinh.chungMinhNhanDan}" required>
                  </td>
                </tr>
                <tr>
                  <td>Nghề nghiệp:</td>
                  <td><input type="text" name="ngheNghiep" class="form-control" value="${thiSinh.ngheNghiep}" required>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input type="text" name="donViCongTac" class="form-control" value="${thiSinh.donViCongTac}"
                             required></td>
                </tr>
                <tr>
                  <td>Chiều cao:</td>
                  <td>
                    <input type="number" name="chieuCao" class="form-control" value="${thiSinh.chieuCao}" required>
                  </td>
                </tr>
                <tr>
                  <td>Cân nặng:</td>
                  <td><input type="number" name="canNang" class="form-control" value="${thiSinh.canNang}" required></td>
                </tr>
                <tr>
                  <td>Năng khiếu khác:</td>
                  <td><input type="text" name="nangKieuKhac" class="form-control" value="${thiSinh.nangKhieuKhac}"
                             required></td>
                </tr>
                <tr>
                  <td>Ảnh cá nhân:</td>
                  <td><input type="text" name="anhCaNhan" class="form-control" value="${thiSinh.anhCaNhan}" required>
                  </td>
