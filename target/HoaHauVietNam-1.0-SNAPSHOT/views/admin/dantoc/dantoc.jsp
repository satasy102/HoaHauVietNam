                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Dân tộc</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-5">
                                    <h2>Danh sách <b>Dân tộc</b></h2>
                                </div>
                                <div class="col-sm-7">
                                    <a href="themdantoc" class="btn btn-secondary"><i
                                            class="material-icons">&#xE147;</i>
                                        <span>Thêm mới Dân tộc</span></a>
                                </div>
                            </div>
                        </div>
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach items="${danhSachDanToc}" var="danhSachDanToc">
                                <tr>
                                    <td>${danhSachDanToc.idDanToc}</td>
                                    <td>${danhSachDanToc.tenDanToc}</td>
                                    <td>
                                        <a href="suadantoc?id=${danhSachDanToc.idDanToc}" class="settings" title="Sửa"
                                           data-toggle="tooltip"><i
                                                class="material-icons">&#xE8B8;</i></a>
                                        <a href="#" class="delete" title="Xóa"
                                           onclick="xoa(${danhSachDanToc.idDanToc},'${danhSachDanToc.tenDanToc}')"
                                           data-toggle="tooltip"><i
                                                class="material-icons">&#xE5C9;</i></a>
                                    </td>
                                </tr>
                        ...
                        <div class="row">
                            <ul class="pagination">
                                <c:forEach begin="1" end="${soTrang}" var="soThuTuTrang">
                                    <li class="page-item">
                                        <a href="showdantoc?idTrang=${soThuTuTrang}" class="page-link">${soThuTuTrang}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
...
<script>
    function xoa(id, name) {
        ...
        if (confirm(messenger)) {
            window.location = "xoadantoc?id=" + id;
        }
    }
</script>
</body>
