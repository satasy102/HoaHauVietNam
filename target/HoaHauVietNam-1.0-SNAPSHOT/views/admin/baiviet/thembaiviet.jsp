            ...
            <div class="container-xl">
                <div class="table-responsive">
                    <div class="table-wrapper">
                        ...
                        <div>
                            <form action="thembaiviet" method="post" id="formDemo">
                                <input type="text" name="anhTieuDe" class="form-control" placeholder="Ảnh tiêu đề">
                                <input type="text" name="tieuDe" class="form-control" placeholder="Tiêu đề">
                                <input type="text" name="noiDungTomTat" class="form-control"
