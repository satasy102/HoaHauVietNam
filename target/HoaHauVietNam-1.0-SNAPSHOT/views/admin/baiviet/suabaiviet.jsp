        ...
        <div class="table-responsive">
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                <div class="col-sm-5">
                  <h2>Sửa <b>Bài Viết</b></h2>
                </div>
                <div class="col-sm-7">
                  <a href="showbaiviet" class="btn btn-secondary">Quay lại</a>
                </div>
              </div>
            </div>
            <div>
              <form action="suabaiviet" method="post" id="formDemo">
                <input type="text" name="anhTieuDe" value="${baiViet.anhTieuDe}" class="form-control" placeholder="Ảnh tiêu đề">
                <input type="text" name="tieuDe" value="${baiViet.tieuDe}" class="form-control" placeholder="Tiêu đề">
                <input type="text" name="noiDungTomTat" value="${baiViet.noiDungTomTat}" class="form-control" placeholder="Nội dung tóm tắt">
                <textarea name="noiDung" id="summernote">${baiViet.noiDung}</textarea>
                <input type="hidden" name="id" value="${baiViet.maBaiViet}">
