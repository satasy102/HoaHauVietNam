        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        <a href="showbaiviet" class="nav-link active">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                Quản lý Bài viết
                            </p>
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-5">
                                    <h2>Danh sách <b>Bài Viết</b></h2>
                                </div>
                                <div class="col-sm-7">
                                    <a href="${pageContext.request.contextPath}/thembaiviet"
                                       class="btn btn-secondary"><i class="material-icons">&#xE147;</i>
                                        <span>Thêm mới bài viết</span></a>
                                </div>
                            </div>
                        </div>
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                            <c:forEach items="${danhSachBaiViet}" var="danhSachBaiViet">
                                <tr>
                                    <td>
                                        <a href="noidungbaiviet?id=${danhSachBaiViet.maBaiViet}">${danhSachBaiViet.tieuDe}</a>
                                    </td>
                                    <td>${danhSachBaiViet.noiDungTomTat}</td>
                                    <td>
                                        <a href="suabaiviet?id=${danhSachBaiViet.maBaiViet}" class="settings"
                                           title="Sửa" data-toggle="tooltip"><i
                                                class="material-icons">&#xE8B8;</i></a>
                                        <a href="#" class="delete" title="Xóa"
                                           onclick="xoa(${danhSachBaiViet.maBaiViet},'${danhSachBaiViet.tieuDe}')"
                        ...
                        <div class="row">
                            <ul class="pagination">
                                <c:forEach begin="1" end="${soTrang}" var="soThuTuTrang">
                                    <li class="page-item">
                                        <a href="showbaiviet?idTrang=${soThuTuTrang}"
...
<script>
    function xoa(id, name) {
        ...
        if (confirm(messenger)) {
            window.location = "showbaiviet?id=" + id;
        }
    }
</script>
</body>
