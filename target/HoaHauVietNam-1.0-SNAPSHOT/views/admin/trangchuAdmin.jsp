...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="admin" class="brand-link">
            <img src="../../admin-assets/dist/img/logo.png" alt="Logo Hoa Hậu"
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-5">
                                    <h2>Danh sách <b>đã đăng ký</b></h2>
                                </div>
                                <div class="col-sm-7">
                                    <a href="themthisinh" class="btn btn-secondary"><i
                                            class="material-icons">&#xE147;</i>
                                        <span>Thêm mới thí sinh</span>
                                    </a>
                                    <form action="admin?action=timtheoten" method="post" class="form-inline">
                        ...
                        <div class="row">
                            <ul class="pagination">
                                <c:forEach begin="1" end="${soTrang}" var="soThuTuTrang">
                                    <li class="page-item">
                                        <a href="admin?idTrang=${soThuTuTrang}" class="page-link">${soThuTuTrang}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
