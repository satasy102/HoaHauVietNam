        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="admin?action=daduyet" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Hồ sơ đã duyệt</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Danh sách thí sinh đã duyệt</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <tr>
                  <td>
                    <a href="thongtinthisinh?id=${danhSachThiSinh.idThiSinh}">
                      <img src="<c:url value="${danhSachThiSinh.anhCaNhan}"/>" class="avatar" alt="Avatar">
                  ...
                  <td>
                    <span class="status text-success ">&bull;</span><a href="xetduyet?id=${danhSachThiSinh.idThiSinh}">Đã duyệt</a>
                  </td>
                  <td>
