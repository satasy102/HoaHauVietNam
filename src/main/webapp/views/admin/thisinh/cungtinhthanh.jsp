                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="admin?action=cungtinhthanh" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Danh sách thí sinh cùng tỉnh thành</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-5">
                                    <h2>Thí sinh cùng <b> tỉnh thành</b></h2>
                                </div>
                                <div class="col-sm-7">
                                    <a href="admin" class="btn btn-secondary">
                                        <span>Trở lại</span></a>
                                    <form action="admin?action=cungtinhthanh" method="post" class="form-inline">
