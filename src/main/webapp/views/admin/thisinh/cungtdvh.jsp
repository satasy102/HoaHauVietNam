                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="admin?action=cungtdvh" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Danh sách thí sinh cùng trình độ văn hóa</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-5">
                                    <h2>Thí sinh cùng <b>Trình độ văn hóa</b></h2>
                                </div>
                                <div class="col-sm-7">
                                    <a href="admin" class="btn btn-secondary">
                                        <span>Trở lại</span></a>
                                    <form action="admin?action=cungtdvh" method="post" class="form-inline">
                                        <select name="id" class="form-control mr-sm-2">
                                            <c:choose>
                                                <c:when test="${trinhDoVanHoa.idTrinhDoVanHoa==null}">
                                                ...
                                                <c:when test="${trinhDoVanHoa.idTrinhDoVanHoa!=null}">
                                                    <option value="${trinhDoVanHoa.idTrinhDoVanHoa}">${trinhDoVanHoa.tenTrinhDoVanHoa}</option>
                                                    <c:forEach items="${danhSachTDVH}" var="danhSachTDVH">
                                                        <option value="${danhSachTDVH.idTrinhDoVanHoa}">${danhSachTDVH.tenTrinhDoVanHoa}</option>
                                                    </c:forEach>
                                                </c:when>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:when test="${danhSachThiSinh.trangThaiDuyet=='Bị loại'}">
                                                <span class="status text-danger ">&bull;</span><a
                                                    href="xetduyet?id=${danhSachThiSinh.idThiSinh}">Bị loại</a>
                                            </c:when>
                                        </c:choose>
                                    </td>
                                    <td>
                                        <a href="suathisinh?id=${danhSachThiSinh.idThiSinh}" class="settings"
                                           title="Sửa"
