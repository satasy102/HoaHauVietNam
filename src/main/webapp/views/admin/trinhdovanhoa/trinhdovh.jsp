        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        <a href="showTDVH" class="nav-link active">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                Quản lý Trình độ VH
                            </p>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Quản lý Trình độ văn hóa</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="admin">Trang chủ</a></li>
                            <li class="breadcrumb-item active">Trình độ văn hóa</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-5">
                                    <h2>Danh sách <b>Trình độ văn hóa</b></h2>
                                </div>
                                <div class="col-sm-7">
                                    <a href="themtdvh" class="btn btn-secondary"><i class="material-icons">&#xE147;</i>
                                        <span>Thêm mới Trình độ văn hóa</span></a>
                                </div>
                            </div>
                        </div>
                        <table class="table table-striped table-hover">
                            <thead>
                            <tr>
                                <th>Mã Trình độ văn hóa</th>
                                <th>Tên Trình độ văn hóa</th>
                                <th>Thao tác</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${danhSachTrinhDoVH}" var="danhSachTrinhDoVH">
                                <tr>
                                    <td>${danhSachTrinhDoVH.idTrinhDoVanHoa}</td>
                                    <td>${danhSachTrinhDoVH.tenTrinhDoVanHoa}</td>
                                    <td>
                                        <a href="suatdvh?id=${danhSachTrinhDoVH.idTrinhDoVanHoa}" class="settings"
                                           title="Sửa" data-toggle="tooltip"><i
                                                class="material-icons">&#xE8B8;</i></a>
                                        <a href="#" class="delete" title="Xóa"
                                           onclick="xoa(${danhSachTrinhDoVH.idTrinhDoVanHoa},'${danhSachTrinhDoVH.tenTrinhDoVanHoa}')"
                        ...
                        <div class="row">
                            <ul class="pagination">
                                <c:forEach begin="1" end="${soTrang}" var="soThuTuTrang">
                                    <li class="page-item">
                                        <a href="showTDVH?idTrang=${soThuTuTrang}"
                                           class="page-link">${soThuTuTrang}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
...
<script>
    function xoa(id, name) {
        let messenger = "Bạn có chắc xóa " + name + " không?";
        if (confirm(messenger)) {
            window.location = "xoatdvh?id=" + id;
        }
    }
</script>
</body>
