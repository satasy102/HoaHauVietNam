        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Thêm Dân tộc</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="table-responsive">
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                <div class="col-sm-5">
                  <h2>Thêm <b>Dân tộc</b></h2>
                </div>
                <div class="col-sm-7">
                  <a href="showdantoc" class="btn btn-secondary">
                    <span>Trở lại</span></a>
                </div>
              </div>
            </div>
            <table class="table table-striped table-hover">
              ...
              <tbody>
              <form action="themdantoc" method="post" id="formDemo">
                <tr>
                  <td><input type="text" name="tenDanToc" class="form-control">
